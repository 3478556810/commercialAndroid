...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.insert("commodity",null,values);
        values.put("id",3);
        values.put("name","原道耳机");
        values.put("belong","津冬超市");
        values.put("intro","NICEHCK 原道耳机Type-C手机3.5mm麦克风HiFi低音流行人声 悔恨之泪版");
        values.put("src","sc4");
        values.put("tag","耳机");
        values.put("prize","9.9");
        db.insert("commodity",null,values);
        values.put("id",4);
        values.put("name","奥特曼神光棒");
        values.put("belong","津冬旗舰");
        values.put("intro","万代（BANDAI） 奥特曼玩具PB魂限定UR迪迦变身器火花棱镜神光棒25周年版 PB神光棒");
        values.put("src","sc5");
        values.put("tag","奥特曼");
        values.put("prize","998");
        db.insert("commodity",null,values);
        values.put("id",5);
